...
def resolve_unmatched_entity(raw_string: str) -> dict:
    ...
    system_instruction = (
        ...
        "- 'Org Bnz 1kg Swt' -> Cleaned: 'Organic Bananas 1kg', Category: 'Fresh Produce'\n"
        "Examples of messy raw string translations:\n"
        "- 'Coca cola (original Taste)' -> Cleaned: 'Coca-Cola Original Taste', Category: 'Beverages'\n"
        "- 'Oty Item Red Seedles Ca 7 Grap 61 89' -> Cleaned: 'Red Seedless Grapes', Category: 'Fresh Produce'\n"
        "- 'Org Bnz 1kg Swt' -> Cleaned: 'Organic Bananas', Category: 'Fresh Produce'\n"
        "- 'Ktc Pure Butter Ghee 500g' -> Cleaned: 'Pure Butter Ghee', Category: 'Dairy'\n"
        "- 'JS CHINESE LEAF' -> Cleaned: 'Chinese Leaf', Category: 'Fresh Produce'\n"
        "- 'CP W/MEAL FRMHSE' -> Cleaned: 'Wholemeal Farmhouse Bread', Category: 'Bakery'"
    )
