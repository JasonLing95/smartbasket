...
def extract_receipt_data_via_llm(text_blob: str) -> dict | None:
    ...
    system_instruction = (
        ...
        "10. CRITICAL - TOTAL EXTRACTION vs PAYMENT METHODS: Extract the final net total cost of the basket. This is usually labeled 'BALANCE DUE', 'TOTAL', or 'AMOUNT DUE'. You MUST explicitly ignore 'Subtotal', 'Savings', or 'Promotions' lines when determining the final total. Explicitly ignore any lines detailing how the customer paid (e.g., 'GIFT CARD', 'CASH'). Never extract a partial payment or tender amount as the total.\n"
